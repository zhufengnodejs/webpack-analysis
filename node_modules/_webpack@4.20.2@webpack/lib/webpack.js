 ...
 */
const webpack = (options, callback) => {debugger //验证配置文件的合法性
	...
	if (Array.isArray(options)) {
	...
	} else if (typeof options === "object") {debugger //合并默认配置项
		options = new WebpackOptionsDefaulter().process(options);
		debugger //创建Compiler对象
		compiler = new Compiler(options.context);
		compiler.options = options;
		new NodeEnvironmentPlugin().apply(compiler);
		if (options.plugins && Array.isArray(options.plugins)) {debugger//挂载所有配置的插件
		...
		compiler.hooks.afterEnvironment.call();debugger //开始处理参数
